def exponential_search(arr, target):
    ...
    Exponential search works by jumping through the array in exponentially 
    increasing steps to find a range where the target might exist, then 
    performs a binary search within that range.
